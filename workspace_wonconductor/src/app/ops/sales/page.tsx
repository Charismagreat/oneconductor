            ...
            <div className="p-8 space-y-8">
              ...
              <div className="space-y-6">
                <div className="space-y-2.5">
                  ...
                  <input 
                    ...
                    className="w-full h-13 px-5 bg-slate-50 dark:bg-slate-900/50 border dark:border-slate-800 border-slate-200 rounded-2xl text-slate-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-blue-500/20 transition-all font-medium"
                  />
                </div>
                ...
                <div className="space-y-2.5">
                  ...
                  <textarea 
                    ...
                    rows={6}
                    className="w-full p-5 bg-slate-50 dark:bg-slate-900/50 border dark:border-slate-800 border-slate-200 rounded-2xl text-slate-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-blue-500/20 transition-all font-medium resize-none"
                  />
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 pt-4">
                <div className="space-y-3">
                  <span className="text-sm font-bold text-slate-500 dark:text-slate-400 ml-1">명함 등록</span>
                  <button className="w-full py-8 flex flex-col items-center justify-center gap-3 bg-slate-50 dark:bg-slate-900/30 border-2 border-dashed dark:border-slate-800 border-slate-200 rounded-[2rem] hover:bg-slate-100 dark:hover:bg-slate-900/50 transition-all group">
                    <Camera className="w-6 h-6 text-slate-400 group-hover:text-blue-500 transition-colors" />
                    <span className="text-xs font-bold text-slate-500 group-hover:text-blue-500 transition-colors">명합 촬영</span>
                  </button>
                </div>
                <div className="space-y-3">
                  <span className="text-sm font-bold text-slate-500 dark:text-slate-400 ml-1">경비 영수증 등록</span>
                  <button className="w-full py-8 flex flex-col items-center justify-center gap-3 bg-slate-50 dark:bg-slate-900/30 border-2 border-dashed dark:border-slate-800 border-slate-200 rounded-[2rem] hover:bg-slate-100 dark:hover:bg-slate-900/50 transition-all group">
                    <Receipt className="w-6 h-6 text-slate-400 group-hover:text-blue-500 transition-colors" />
                    <span className="text-xs font-bold text-slate-500 group-hover:text-blue-500 transition-colors">영수증 첨부</span>
                  </button>
                </div>
              </div>
