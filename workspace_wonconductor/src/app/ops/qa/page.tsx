            ...
            <div className="space-y-6">
              <div className="space-y-2.5">
                ...
                <input 
                  ...
                  className="w-full h-13 px-5 bg-slate-50 dark:bg-slate-900/50 border dark:border-slate-800 border-slate-200 rounded-2xl text-slate-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-rose-500/20 transition-all font-bold"
                />
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-2.5">
                  ...
                  <div className="relative group">
                    <select className="w-full h-13 px-4 bg-slate-50 dark:bg-slate-900/50 border dark:border-slate-800 border-slate-200 rounded-2xl text-slate-900 dark:text-white appearance-none focus:outline-none focus:ring-2 focus:ring-rose-500/20 transition-all font-bold">
              ...
              <div className="space-y-2.5">
                ...
                <textarea 
                  ...
                  rows={4}
                  className="w-full p-5 bg-slate-50 dark:bg-slate-900/50 border dark:border-slate-800 border-slate-200 rounded-2xl text-slate-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-rose-500/20 transition-all font-bold resize-none text-sm"
                />
              </div>

              <div className="space-y-4 pt-2">
                <PhotoUpload label="현장 부적합 증빙 사진 첨부" maxPhotos={5} />
              </div>
          ...
          <div className="dark:bg-[#0B1120] bg-white rounded-3xl border dark:border-slate-800 border-slate-200 shadow-xl overflow-hidden p-8 space-y-8">
            ...
            <div className="space-y-6">
                ...
                <div className="flex gap-2">
                  <div className="relative flex-1">
                    <input 
                      ...
                      className="w-full h-13 px-5 bg-slate-50 dark:bg-slate-900/50 border dark:border-slate-800 border-slate-200 rounded-2xl text-slate-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-indigo-500/20 transition-all font-bold"
                    />
                  </div>
                  <button className="h-13 px-5 bg-slate-900 dark:bg-slate-800 text-white rounded-2xl font-black text-sm flex items-center gap-2 hover:bg-slate-800 transition-all active:scale-95">
              ...
              <div className="pt-4 space-y-4">
                ...
                <PhotoUpload label="문서 촬영 및 데이터 추출" maxPhotos={3} showOcr={true} />
              </div>
